...
public class Aninhamento extends JFrame {
	...
	public Aninhamento(){
		...
		});//criando classe anonima diretamente nos parâmetros
	...
	public class ListenerAninhado implements ActionListener{//classe interna
	...
	public static void main(String[] args) {
		...
		Aninhamento.ListenerAninhado listener = janela.new ListenerAninhado();//criando objeto da classe interna
